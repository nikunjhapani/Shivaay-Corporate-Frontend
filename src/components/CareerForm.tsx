...
export default function CareerForm() {
  ...
  return (
    <form className="contactForm row y-gap-30 pt-30" onSubmit={handleSubmit}>
      ...
      <div className="col-6">
        <div className="form-input">
          <input name="mobileNo" type="text" required value={formData.mobileNo} onChange={handleChange} />
      ...
      <div className="col-12">
        <div className="form-input">
          <textarea name="address" rows={4} required className="border-1" value={formData.address} onChange={handleChange}></textarea>
      ...
      <div className="col-md-4">
        <div className="form-input">
          <input name="country" type="text" required value={formData.country} onChange={handleChange} />
      ...
      <div className="col-12">
        <div className="form-input">
          <textarea name="message" rows={8} required className="border-1" value={formData.message} onChange={handleChange}></textarea>
          <label className="lh-1 text-14">Message</label>
        </div>
      </div>

      <div className="col-12 text-right">
        <button type="submit" className="button -md -type-2 bg-accent-2 -accent-1 text-white">
          Submit
        </button>
      </div>
