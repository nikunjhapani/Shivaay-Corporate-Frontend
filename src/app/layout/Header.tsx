...
export default function Header() {
  ...
  return (
    <>
      <div
        className={`menuFullScreen js-menuFullScreen ${isOpen ? "is-active" : ""}`}
      >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              className="menuFullScreen__mobile__bg js-menuFullScreen-mobile-bg"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
        ...
        <AnimatePresence>
          {isOpen && (
            <>
              <motion.div
                className="menuFullScreen__left"
                initial={{ y: "-100%" }}
                animate={{ y: 0 }}
                exit={{ y: "-100%" }}
                transition={{ duration: 1 }}
              ...
              >
                <div className="text-center">
                  ...
                  <div className="mt-40">
                    <div className="text-24 text-sec text-white fw-500">Phone Support</div>
                  ...
                  <div className="mt-40">
                    <div className="text-24 text-white text-sec fw-500">Connect With Us</div>
                    <div className="mt-10 text-white">
